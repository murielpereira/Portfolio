export function getSidebar() {
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li><div id="nav-entregas" class="nav-link" onclick="mostrarSubPaginaDash('entregas')"><i data-lucide="truck"></i> <span class="nav-text">Entregas</span></div></li>
            ...
            <li><div id="nav-whatsapp" class="nav-link" onclick="mostrarSubPaginaDash('whatsapp')"><i data-lucide="message-circle"></i> <span class="nav-text">WhatsApp</span></div></li>
